...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private OnPreparedListener mPreparedListener = new OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            if (duringTimeListener != null) {
                duringTimeListener.onGetDuringTime( getDuration());
            }
    ...
    public interface OnGetDuringTimeListener {
        public void onGetDuringTime(long during);
    }
    private OnGetDuringTimeListener duringTimeListener;
    public void setOnGetDuringTimeListener(OnGetDuringTimeListener duringTimeListener) {
        this.duringTimeListener = duringTimeListener;
    }
    ...
    public void setVideoPath(String path,long defaultSeek) {
        setVideoURI(Uri.parse(path),defaultSeek);
    }

    public void setVideoURI(Uri uri,long defaultSeek) {
        setVideoURI(uri, defaultSeek,null);
    }

    public void setVideoURI(Uri uri,long defaultSeek, Map<String, String> headers) {
        mUri = uri;
        mHeaders = headers;
        mSeekWhenPrepared = defaultSeek;
        openVideo();
        requestLayout();
        invalidate();
    }
...
//  }
     ...
     * 增加缓冲处理
     *
     * @param bufSize <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
     * @author 许华维(WAH-WAY)
     * <p>创建日期 ：2015-12-15 下午2:20:52</p>
     */
     ...
     * 设置字幕
     *
     * @param subPath <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
     * @author 许华维(WAH-WAY)
     * <p>创建日期 ：2015-12-15 下午2:19:58</p>
     */
     ...
     * 设置倍速播放（快进快退）
     *
     * @param speed 0.5 - 2.0默认是 1.0
     *              <p>
     *              <p>修改历史 ：(修改人，修改时间，修改原因/内容)</p>
     * @author 许华维(WAH-WAY)
     * <p>创建日期 ：2015-12-15 下午2:18:32</p>
     */
